...
void dlio::OdomNode::getParams() {
  ...
  std::vector<double> imu2baselink_t, imu2baselink_R;
  dlio::declare_param(this, "extrinsics/imu2baselink/t", imu2baselink_t, t_default);
  dlio::declare_param(this, "extrinsics/imu2baselink/R", imu2baselink_R, R_default);
  ...
  this->extrinsics.imu2baselink.R =
    Eigen::Map<const Eigen::Matrix<float, -1, -1, Eigen::RowMajor>>(std::vector<float>(imu2baselink_R.begin(), imu2baselink_R.end()).data(), 3, 3);
  ...
  std::vector<double> lidar2baselink_t, lidar2baselink_R;
  dlio::declare_param(this, "extrinsics/lidar2baselink/t", lidar2baselink_t, t_default);
  dlio::declare_param(this, "extrinsics/lidar2baselink/R", lidar2baselink_R, R_default);
  ...
  this->extrinsics.lidar2baselink.R =
    Eigen::Map<const Eigen::Matrix<float, -1, -1, Eigen::RowMajor>>(std::vector<float>(lidar2baselink_R.begin(), lidar2baselink_R.end()).data(), 3, 3);
...
sensor_msgs::msg::Imu::SharedPtr dlio::OdomNode::transformImu(const sensor_msgs::msg::Imu::SharedPtr& imu_raw) {
  ...
  Eigen::Vector3f lin_accel_cg = this->extrinsics.imu2baselink.R * lin_accel;
